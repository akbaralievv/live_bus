...
const products = [
  ...
  {
    name: 'Наши автобусы',
    description: 'Есть 3 класса автобусов',
    href: '#',
    icon: CurrencyDollarIcon,
    path: '/aboutUs/priceList',
  },
  {
    name: 'Руководство',
    description: 'Как купить билет?',
    href: '#',
    icon: BookOpenIcon,
      ...
      <nav
        ...
        <div className="flex lg:flex-1">
          <NavLink to="/" className="-m-1.5 p-1.5">
            <span className="sr-only">Live Bus</span>
        ...
        <Popover.Group className="hidden lg:flex lg:gap-x-12">
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              isActive
                ? 'text-lg font-semibold leading-6 text-gray-900 border-b-2 border-black transition duration-300'
